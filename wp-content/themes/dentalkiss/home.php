            ...
            <?php foreach (getAbout() as $about) : ?>
				...
				<div class="card border-0 med-blog">
					...
					<div class="card-body border border-top-0">
							...
							<p><?php echo wp_trim_words($about -> post_excerpt, '12' ); ?></p>
						</div>
...
<!-- banner-->
<section class="loan_w3ls p-5"><span id="services"></span></section>
<!-- //banner -->
			...
			<div class="services-boxes">
                ...
                foreach (getServices() as $services) : ?>
                    <a href="#sv<?php echo $i; ?>"
                       rel="modal:open"
                       class="services-box wow animate__animated animate__zoomIn">
...
<section class="loan_w3ls py-5">
	<div class="container">
		<div class="row text-center">
			<div class="col-lg-6 wow animate__animated animate__zoomInDown">
			...
			<div class="col-lg-6 wow animate__animated animate__zoomInUp">
                <?php echo do_shortcode('[contact-form-7 id="5" title="Контактна форма 1"]'); ?>
			</div>
		</div>
        <span id="team"></span>
...
<div class="team py-5">
	<div class="container">
		<div class="mb-4">
			...
			<p class="mt-1 text-center">Наш дружній колектив завжди прийде Вам на допомогу</p>
		</div>
...
<!-- banner-->
<section class="loan_w3ls py-5"><span id="blog"></span></section>
<!-- //banner -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 med-blog">
                        ...
                        <div class="card-body border border-top-0 pb-5">
                            <div class="mb-3">
                                <h5 class="blog-title card-title m-0"><?php echo $blog->post_title; ?></h5>
                                <div class="blog_w3icon">
                                    <span><?php echo get_the_date('F d, Y', $blog->ID) ?></span>
                                </div>
                            </div>
                            <p class="mb-4"><?php echo wp_trim_words($blog->post_excerpt, '12' ); ?></p>
